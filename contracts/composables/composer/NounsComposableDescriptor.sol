...
contract NounsComposableDescriptor is INounsComposableDescriptor, Ownable {
    ...
    function dataURI(uint256 tokenId, INounsSeeder.Seed memory seed) public view override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked('Nouns Breeder ', nounId));
        string memory description = string(
            abi.encodePacked('Nouns Breeder ', nounId, ' is a collectible in Nouns ecosystem.')
        );
     ...
     */
    function generateSVGImage(uint256 tokenId, INounsSeeder.Seed memory seed)
        external
        view
        override
     ...
     */
    function getPartsForSeed(uint256 tokenId, INounsSeeder.Seed memory seed)
        public
        view
